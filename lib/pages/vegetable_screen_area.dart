...
class VegetableAreaScreen extends StatefulWidget {
  final vegetableData, city;
  const VegetableAreaScreen({Key? key, required this.vegetableData, required this.city})
      : super(key: key);

  @override
  State<VegetableAreaScreen> createState() => _VegetableAreaScreenState();
}
...
class _VegetableAreaScreenState extends State<VegetableAreaScreen> {
  var chartData;
